# **App Name**: CheckInBonus

## Core Features:

- User Management: User authentication and authorization system with distinct roles for administrators and collaborators, ensuring secure access to the application based on their respective privileges.
- Task Management: Allows administrators to create, edit, and manage tasks with detailed descriptions, criteria, and categories. Tasks can be assigned to specific roles or individual collaborators.
- Evaluation System: Enables administrators to evaluate collaborators' task completion with a binary (10 or 0) scoring system. Administrators can add justifications for scores and review/edit recent evaluations.
...
- Accent: A vibrant green (#2ecc71) for positive affirmations and completed tasks.
- Use a card-based layout for displaying tasks and evaluations.
- Use clear and intuitive icons to represent different task categories and actions.
