 ...
 export default function EmployeeChallengesPage() {
     ...
     const categorizedChallenges = React.useMemo(() => {
        console.log("[CollabChallengesPage] Recalculating categorizedChallenges...");
        console.log("[CollabChallengesPage] allChallenges:", allChallenges.length, "participations:", participations.length, "currentUserProfile:", currentUserProfile);
        ...
        allChallenges.forEach(challenge => {
            ...
            if (currentUserProfile) {
                ...
                console.log(`[CollabChallengesPage] User profile not loaded, falling back for eligibility check for challenge ${challenge.id}. Type: ${challenge.eligibility.type}`);
                isEligible = true;
            }
            
            // console.log(`[CollabChallengesPage] Challenge ${challenge.id} (${challenge.title}): Eligible: ${isEligible}, Status: ${challenge.status}, Participation: ${participationStatus}, PeriodOver: ${isChallengePeriodOver}, NotStarted: ${isChallengeNotStartedYet}`);


            if (!isEligible || challenge.status === 'draft' || challenge.status === 'archived') {
                 // console.log(`[CollabChallengesPage] Challenge ${challenge.id} SKIPPED (Ineligible, Draft, or Archived).`);
                return;
            }
        ...
        console.log(`[CollabChallengesPage] Categorized - Available: ${available.length}, Active: ${active.length}, Completed: ${completed.length}`);
