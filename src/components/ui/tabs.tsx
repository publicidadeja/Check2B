 ...
 >(({ className, ...props }, ref) => (
   <div className="overflow-x-auto whitespace-nowrap pb-1 -mb-1"> {/* Add scroll container */}
       <TabsPrimitive.List
         ref={ref}
         className={cn(
           "inline-flex h-9 items-center justify-start rounded-md bg-muted p-1 text-muted-foreground min-w-full w-max", // Ensure it can exceed container width
           className
         )}
         {...props}
       />
